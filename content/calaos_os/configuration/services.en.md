...
The additional services (MQTT, Zigbee, history, graphs…) run in containers. To see which ones are active:

```sh
podman ps
```

They are presented in detail on the [Services and modules]({{% relref "calaos_os/containers" %}}) page.
